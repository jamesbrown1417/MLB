...
# URL of website
betr_url =
  "https://api.betr.ext.thebetmakers.com/api/v4/combined/sports/basecompetition/events-with-markets?base_competition_id=1000002&main_markets_only=false"
...
betr_data <-
  ...
  separate(match, c("home_team", "away_team"), sep = " vs ") |> 
  ...
  mutate(start_time = as.character(start_time - minutes(30)))
